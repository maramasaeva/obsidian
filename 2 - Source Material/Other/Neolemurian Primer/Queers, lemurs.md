...
My claim: It seems the description of lemurs or demons aligns beautifully with queers, when seen as those living in the margins, margins created by the dominance of the cis-het patriarchal capitalists. Those lemurs are also MULTIPLE, VIOLENT, RECONNECTED. Queers cross borders; now i wonder whether they possess as well the other characteristics of lemurs: operating between intervals of nonqueers fields of actions, nomadic life, and most importantly, conceptually preceding the Queer/Actuality concepts parallel to "chronology" & "difference" in neolemurian digital hyperstition? 
